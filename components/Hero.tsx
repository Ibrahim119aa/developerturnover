...
const Hero = ({ title }: HeroProps) => {
    return (
        <section className="relative bg-[#F8F8F8] transition-all duration-300 mt-0 mb-0 py-20 sm:py-20 md:py-28 lg:py-[180px] xl:py-[200px] px-4 sm:px-6">
                ...
                <div className="flex relative min-h-[1px] w-full">
                    <div className="flex flex-wrap justify-center items-start w-full p-0 m-0">
                        <div className="text-center w-full" data-aos="zoom-in">
                            <h1 className="text-white font-extrabold text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-[5.5rem] leading-tight m-0 p-0">
                                {title}
                            </h1>
                        </div>
                    </div>
