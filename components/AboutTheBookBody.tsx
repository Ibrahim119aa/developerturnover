...
const AboutTheBookBody = () => {
    return (
        <div className="bg-[#B4D6E3]">
            <div className=" flex flex-row flex-wrap md:flex-nowrap pt-[10px] px-0 pb-0 mx-auto max-w-[1280px] w-full">
                <div className="flex flex-row flex-wrap justify-normal items-normal content-normal w-full max-w-7xl mx-auto gap-0 pt-[80px] pb-0 px-0">
                    <div className="flex flex-col justify-center gap-2 w-full md:w-1/2 pr-10">
                        <div className="relative max-w-full min-w-0 mb-0 transition-all duration-300">
                            <h2 className="text-[25px] text-[#062233] leading-10 m-0 p-0 font-bold">
                                About This Guidebook
                            </h2>
                        </div>
                        <div className="relative max-w-full min-w-0  transition-all duration-300 animate-[fadeInUp_1.25s]">
                            <h2 className="text-[40px] leading-12 text-[#062233]  m-0 p-0 font-extrabold">
                        ...
                        <div className="relative max-w-full min-w-0 text-[#062233] transition-all duration-300 mb-0">
                            <p className="mt-0 mb-[0.9rem] text-[#062233]">
                    ...
                    <div className="flex flex-col justify-center w-full md:w-1/2">
                        <div className="relative max-w-full min-w-0 mb-0 text-center transition-all duration-300 animate-[fadeInRight_1s]">
                            <Image className="inline-block align-middle h-[500px] w-auto object-contain object-center border-0 shadow-none rounded-none max-w-full" src={"/images/AboutTheBook.jpg"} alt="Description" width={500} height={300} />
                        </div>
                    </div>
                </div>
