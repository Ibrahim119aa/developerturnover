...
const AuthorBody = () => {
    return (
        <div>
            <div className="relative bg-[#B4D6E3] transition-all duration-300 mt-0 mb-0 pt-8 sm:pt-12 md:pt-[100px] pb-0">
                    ...
                    <div className="w-full md:w-[42.543%] flex relative min-h-[1px] justify-center md:justify-start" data-aos="fade-right">
                        <div className="m-0 pr-0 md:pr-[25px] pt-0 pb-0 pl-0 w-full max-w-[300px] sm:max-w-md md:max-w-none">
                            <div className="transition-[background,border,border-radius,box-shadow,transform] duration-300">
                                <Image src={"/images/author.jpg"} alt="author" width={500} height={500} className="h-auto sm:h-[360px] md:h-[500px] lg:h-[700px] w-full object-cover object-center" />
                            </div>
                        </div>
                    </div>
                    <div className="flex relative min-h-[1px] w-full md:w-[57.457%] gap-4 md:gap-5 transition-all duration-300 mt-6 md:mt-0" data-aos="fade-left">
                        <div className="pl-0 md:pl-[75px] p-2 md:p-[10px] flex flex-wrap content-start relative w-full gap-4 md:gap-5">
                            <div className="w-full relative transition-all duration-300">
                                <h2 className="text-base sm:text-lg md:text-[25px] font-extrabold capitalize text-[#0E113C] leading-normal m-0 p-0 font-sans">
                                    About The Author
                                </h2>
                            </div>
                            <div className="w-full relative transition-all duration-300">
                                <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-[3rem] font-extrabold capitalize text-[#0E113C] leading-tight m-0 p-0 font-sans">
                                    Matt Leukroth, MBA, LCAM
                                </h2>
                            </div>
                            <div className="w-full relative transition-all duration-300">
                                <p className="mt-0 mb-[1.5rem] text-[#0E113C] [word-spacing:6px] text-sm sm:text-base md:text-[18px] font-sans">Matt Leukroth, MBA, LCAM, has been in the property management and developer industries for more than twenty years. After beginning his career in food &amp; beverage management, he began his experiences with developers and property management by spending several years with a public developer of lifestyle and golf club communities. As general manager of several developer owned assets, such as elaborate community town centers, private food &amp; beverage operations, lifestyle amenities, and golf club &amp; course operations, he gained extensive development and operational knowledge of private club facilities, in addition to participation on multiple association boards as a developer appointed director.</p>
                                <p className="mt-0 text-[#0E113C] [word-spacing:6px] text-base sm:text-[18px] font-sans">During the real estate market downturn, while developers were struggling and making massive layoffs, Matt migrated to the property management side of the real estate arena, working with a large successful state-wide management company. As a regional director of a business unit comprised of mostly developer accounts (many of which being those of the same developer for which he’d previously worked), he gained extensive experience and knowledge in the developer turnover process by working through multiple transitions from the property management and association side of that process.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="bg-[#B4D6E3]">
                <div className="flex flex-col pt-5 pb-12 md:pb-20 px-4 sm:px-6 max-w-[1280px] mx-auto" data-aos="fade-up">
