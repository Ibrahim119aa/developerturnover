    ...
    return (
        <div>
            <div className="relative bg-[#B4D6E3] transition-all duration-300 mt-0 mb-0 pt-8 sm:pt-12 md:pt-[100px] pb-0">
                ...
                <div className="flex flex-col md:flex-row relative mx-auto max-w-[1140px] 2xl:max-w-[1280px] px-4 sm:px-6 md:px-0">
                    <div className="w-full md:w-[42.543%] flex relative min-h-[1px] justify-center md:justify-start">
                        <div className="m-0 pr-0 md:pr-[25px] pt-0 pb-0 pl-0 w-full max-w-md md:max-w-none">
                            <div className="transition-[background,border,border-radius,box-shadow,transform] duration-300">
                                <Image src={"/images/author.jpg"} alt="author" width={500} height={500} className="h-[280px] sm:h-[400px] md:h-[500px] lg:h-[700px] w-full object-cover object-center" />
                            </div>
                        </div>
                    </div>
                    <div className="flex relative min-h-[1px] w-full md:w-[57.457%] gap-4 md:gap-5 transition-all duration-300 mt-6 md:mt-0">
            ...
            <div className="bg-[#B4D6E3]">
                <div className="flex flex-col pt-5 pb-12 md:pb-20 px-4 sm:px-6 max-w-[1280px] mx-auto animate-fadeInUp">
