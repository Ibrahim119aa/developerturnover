...
const TableOfContentBody = () => {
    return (
        <div className="toc-wrapper">
            ...
            <div className="container-toc flex relative box-border" data-aos="fade-up">
                <div className="flex relative min-h-[1px] w-full transition-all duration-300 box-border overflow-x-auto -mx-2 sm:mx-0">
                    <div className="m-0 p-2 sm:p-[10px] flex flex-wrap content-start w-full min-w-0 relative box-border">
                        <div className={`${montserrat.className} toc-body w-full relative text-xs sm:text-sm md:text-base lg:text-[19px] text-black transition-all duration-300 min-w-0`}>
                            <table className="toc-table w-full border-collapse text-[0.85em] sm:text-[0.9em] border-4 border-[#80808012]">
                                <thead className="bg-transparent">
                                    <tr>
                                        <th className="toc-table-cell-center border-2 border-[#80808012]">Sr. No.</th>
                                        <th className="toc-table-cell border-2 border-[#80808012] text-center">Section Title</th>
                                        <th className="toc-table-cell-center border-2 border-[#80808012]">Page No.</th>
                                    </tr>
                                </thead>
                                <tbody className="align-middle">
                                    {tocRows.map((row, index) => (
                                        ...
                                        >
                                            <td className="toc-table-cell-center">{row.sr}</td>
                                            <td className="toc-table-cell break-words">{row.title}</td>
                                            <td className="toc-table-cell-center">{row.page}</td>
                                        </tr>
                                    ))}
                                </tbody>
                            </table>
